...
void set_plugboard(char a, char b, char c, char d, char e, char f, char g, char h, char i, char j, char k, char l)
{
...
int main(){
	...
	int riI, riII, riIII;
	//cout << "Please input the rotor(From left to right): ";
	riI = 3;
	riII = 2;
	riIII = 5;
													...
													for (int ii = 0; ii < 26; ii++)
													{
														...
														for (int jj = 0; jj < 26; jj++)
														{
															...
															for (int kk = 0; kk < 26; kk++)
															{
																...
																now_rotorII = 'A' + jj;
																now_rotorIII = 'A' + kk;
																cout << "now_rotorI = " << now_rotorI << "  now_rotorII = " << now_rotorII << "  now_rotorIII = " << now_rotorIII << endl;
